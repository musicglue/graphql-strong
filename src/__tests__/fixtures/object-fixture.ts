...
// All good person
PersonType.fieldNonNull<string>({
  name: "name",
  type: StringType,
  resolve: ({ name }) => name,
})
...
ImageType.fieldNonNull<string | null | undefined>({
  name: "url",
...
PersonType.field<Image, { width: number; height: number | null | undefined }>({
  name: "image",
  type: StringType,
  args: {
    width: {
...
PersonType.field<Image, { width: number; height: number | null | undefined }>({
  ...
  resolve: ({ imageURL }, { width, height, x, y, z }) =>
    imageURL
      ? {
          url: imageURL,
          width,
...
PersonTypeWithContext.field<Image>({
  name: "smallImage",
  type: ImageType,
