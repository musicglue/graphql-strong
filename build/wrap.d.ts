...
export declare const IntegerListType: StrongInputOutputType<number[]>;
export declare const FloatListType: StrongInputOutputType<number[]>;
export declare const StringListType: StrongInputOutputType<string[]>;
export declare const BooleanListType: StrongInputOutputType<boolean[]>;
export declare const IDTypeListType: StrongInputOutputType<string[]>;
/**
